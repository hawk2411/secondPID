...
void CircleCreator::paint ( QPainter * painter, const QStyleOptionGraphicsItem *, QWidget*)
{
...
QRectF CircleCreator::boundingRect () const
{
	return m_rectangle;
}

void CircleCreator::mouseMoveEvent ( QGraphicsSceneMouseEvent * mouseEvent )
{
	QRectF newRect;
	QPointF pt;
...
void CircleCreator::mousePressEvent ( QGraphicsSceneMouseEvent * mouseEvent )
{
	if (mouseEvent->button() == Qt::LeftButton) 
	{
		...
		else
		{
			...
			{
				GraphicsEllipseItem *pItem = new GraphicsEllipseItem(m_rectangle);
...
bool CircleCreator::endCreation()
{
